...
Note to users that they can only mint/create/register IP on Story Odyssey Testnet; support for Mainnet is coming soon.
...
Remind users once again they can only mint/create/register IP on Story Odyssey Testnet; support for Mainnet is coming soon.
